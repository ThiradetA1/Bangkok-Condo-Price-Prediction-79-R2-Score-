## Bangkok Condo Price Prediction
...
##  Key Results
* **Model Accuracy:** 79% R2 Score
* **Error Reduction:** Reduced Mean Absolute Error (MAE) from **25M THB to 1.1M THB** by filtering luxury segments and optimizing hyperparameters.
* **Best Model:** Random Forest 

##  Tech Stack
* **Language:** Python
* **Data Acquisition:** Selenium
